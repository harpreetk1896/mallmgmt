...
public class ViewPro extends javax.swing.JFrame {
    ...
    public ViewPro() {
        ...
        this.setSize(x,y);
        DisplayProData dst=new DisplayProData(model,"select * from happy.product");
    ...
    private void jTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldKeyReleased
        ...
        sql_query = "select * from happy.product where pid like "+"'%"+search_text+"%'"
                +" or lower(pname) like "+"'%"+search_text+"%'"+" or lower(pinfo) like "+"'%"+search_text+"%'"+
                " or qty = "+search_text+" or s_price = "+search_text;
        else
        sql_query = "select * from happy.product where lower(pname) like "+"'%"+search_text+"%'"+""
                + " or lower(pinfo) like "+"'%"+search_text+"%'" + " or pid like "+"'%"+search_text+"%'";
